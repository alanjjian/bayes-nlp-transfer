...
def main():
    ...
    # This boots up some sort of config file that describes the architecture of the model
    ...
    if training_args.do_train:
        ...
        train_dataset.save_to_disk("bookcorpus_train.hf")
    ...
    if training_args.do_eval:
        ...
        eval_dataset.save_to_disk("bookcorpus_val.hf")
