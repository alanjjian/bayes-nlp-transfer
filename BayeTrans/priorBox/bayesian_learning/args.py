...
def parse_args_SBL(parser):
    ...
    parser.add_argument('--run_bma', action='store_true', help='run bayesian model averaging at the end')
    ...
    # Custom
    parser.add_argument('--just_eval', action='store_true', help='just runs bma while bypassing training')
